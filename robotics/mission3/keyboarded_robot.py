...
class GoPiGo3WithKeyboard(object):
    ...
    def __init__(self):
        ...
        "z" : ["Check if something is infront of the robot", "distance"],
        ...
        self.order_of_keys = ["w", "s", "a", "d", "<SPACE>", "<F1>", "<F2>", "<F3>", "1", "2", "3", "8", "9", "0", "z", "<INSERT>", "<ESC>"]
    ...
    def _gopigo3_command_distance(self):
        ...
        self.lNum += 1
        if(dist < 3000):
            f.write('\nCar in lot #' + str(self.lNum))            
        else:
            f.write('\nNo Car in lot #' + str(self.lNum))
